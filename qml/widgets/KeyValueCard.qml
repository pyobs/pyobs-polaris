...
// Every future interface-specific widget (Phase 7's CameraWidget, etc.)
// embeds this for whatever it doesn't want to hand-design its own UI for -
// same role as ModuleStateCard.vue/KeyValueCard.vue in the web client.
ColumnLayout {
    id: root
